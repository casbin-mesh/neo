...
func GeneratePlanEffectPolicyAst(policyTable, eftColumnName, reqAccessor string) ast.Evaluable {
	return &ast.BinaryOperationExpr{
		...
		R: &ast.Accessor{
			Typ: ast.MEMBER_ACCESSOR, Ancestor: &ast.Primitive{Typ: ast.IDENTIFIER, Value: reqAccessor}, Ident: &ast.Primitive{Typ: ast.IDENTIFIER, Value: eftColumnName},
		},
	}
}

func GenerateMatcherEffectPolicyAst(policyTable, eftColumnName, allow, deny string, policyType EffectPolicyType) []ast.Evaluable {
	Asts := [][]ast.Evaluable{
		{
